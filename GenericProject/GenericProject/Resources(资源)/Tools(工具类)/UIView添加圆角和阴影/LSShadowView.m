...
- (void)ls_shaodw {
    [self ls_shaodwRadius:5 shadowColor:[UIColor colorWithWhite:0 alpha:0.3] shadowOffset:CGSizeMake(0, 0) byShadowSide:LSShadowSideAllSides];
}

- (void)ls_verticalShaodwRadius:(CGFloat)shadowRadius shadowColor:(UIColor *)shadowColor shadowOffset:(CGSize)shadowOffset {
    [self ls_shaodwRadius:shadowRadius shadowColor:shadowColor shadowOffset:shadowOffset byShadowSide:LSShadowSideTop|LSShadowSideBottom];
}

- (void)ls_horizontalShaodwRadius:(CGFloat)shadowRadius shadowColor:(UIColor *)shadowColor shadowOffset:(CGSize)shadowOffset {
    [self ls_shaodwRadius:shadowRadius shadowColor:shadowColor shadowOffset:shadowOffset byShadowSide:LSShadowSideLeft|LSShadowSideRight];
}

- (void)ls_shaodwRadius:(CGFloat)shadowRadius shadowColor:(UIColor *)shadowColor shadowOffset:(CGSize)shadowOffset byShadowSide:(LSShadowSide)shadowSide {
...
- (void)ls_cornerRadius:(CGFloat)cornerRadius byRoundingCorners:(UIRectCorner)corners {
    _cornerRadius = cornerRadius;
    _rectCorner   = corners;
}
...
// 绘制阴影
- (void)_setShadowWithShadowRadius:(CGFloat)shadowRadius shadowColor:(UIColor *)shadowColor shadowOffset:(CGSize)shadowOffset byShadowSide:(LSShadowSide)shadowSide {

    if (shadowRadius <= 0) {
        return;
    }
    
    if (shadowSide & LSShadowSideTop) {
        [self _setSingleSideShadowWithShadowRadius:shadowRadius shadowColor:shadowColor shadowOffset:shadowOffset byShadowSide:LSShadowSideTop];
    }
    
    if (shadowSide & LSShadowSideBottom) {
        [self _setSingleSideShadowWithShadowRadius:shadowRadius shadowColor:shadowColor shadowOffset:shadowOffset byShadowSide:LSShadowSideBottom];
    }
    
    if (shadowSide & LSShadowSideLeft) {
        [self _setSingleSideShadowWithShadowRadius:shadowRadius shadowColor:shadowColor shadowOffset:shadowOffset byShadowSide:LSShadowSideLeft];
    }
    
    if (shadowSide & LSShadowSideRight) {
        [self _setSingleSideShadowWithShadowRadius:shadowRadius shadowColor:shadowColor shadowOffset:shadowOffset byShadowSide:LSShadowSideRight];
    }
}

// 绘制单边阴影
- (void)_setSingleSideShadowWithShadowRadius:(CGFloat)shadowRadius shadowColor:(UIColor *)shadowColor shadowOffset:(CGSize)shadowOffset byShadowSide:(LSShadowSide)shadowSide {
    ...
    } else if (shadowSide & LSShadowSideLeft) {
    ...
    } else if (shadowSide & LSShadowSideRight) {
    ...
    } else if (shadowSide & LSShadowSideBottom) {
