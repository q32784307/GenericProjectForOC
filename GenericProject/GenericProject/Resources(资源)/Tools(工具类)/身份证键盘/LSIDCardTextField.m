...
#import "LSIDCardTextField.h"
#import "UIView+Extension.h"
#import "UITextField+LSExtension.h"

@interface LSIDCardTextField ()
...
@implementation LSIDCardTextField
...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 8.0) {
        if (![UIView foundViewInView:tempWindow clazzName:@"UIKeyboardAutomatic"]) return;
    }
...
- (void)setupDownKey {
    ...
    UIButton *doneButton = [[UIButton alloc] initWithFrame:CGRectMake(doneButtonX, doneButtonY + 5, doneButtonW, doneButtonH)];
