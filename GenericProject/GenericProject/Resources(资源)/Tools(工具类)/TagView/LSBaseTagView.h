...
@property(nonatomic,assign)LSCustomButtonType buttonType; // 图片文字布局方式  --- 只支持图片文字横向排列  不支持图片和title 上下排
...
@property(nonatomic,strong)NSArray<LSBaseTagViewModel *> *tagArray;
...
@property(nonatomic,copy)void (^tagViewClickNew)(NSInteger curentClickSection,NSInteger curentClickIndex,LSCustomButton *btn); // 当前选中index
