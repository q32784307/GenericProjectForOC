//
//  LSPSWRectNormalTextFieldView.m
//  GenericProject
//
...
@interface LSPSWRectNormalTextFieldView ()
...
@implementation LSPSWRectNormalTextFieldView
...
- (void)p_initDotViewWithFrame:(CGRect)frame {
    ...
    for (int i = 0; i < kMaxCount; i ++) {
        ...
        LSPasswordDotView *dotView = [LSPasswordDotView createDotViewWithType:LSPasswordRectangleNormal
                                                                        frame:frame];
