//
//  LSPSWLineEncryptTextFiledView.m
//  GenericProject
//
...
@interface LSPSWLineEncryptTextFiledView ()
...
@implementation LSPSWLineEncryptTextFiledView
...
- (void)p_initDotViewWithFrame:(CGRect)frame {
    ...
    for (int i = 0; i < 6; i ++) {
        ...
        LSPasswordDotView *dotView = [LSPasswordDotView createDotViewWithType:LSPasswordBottomLineEncrytion
                                                                        frame:frame];
