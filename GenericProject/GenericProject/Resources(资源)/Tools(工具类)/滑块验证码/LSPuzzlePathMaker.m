...
@implementation LSPuzzlePathMaker
...
#pragma mark -- Getter
- (LSPuzzlePathMaker *(^)(CGFloat, CGFloat))moveTo {
...
- (LSPuzzlePathMaker *(^)(CGFloat, CGFloat))addLineTo {
    return ^(CGFloat x, CGFloat y){
...
- (LSPuzzlePathMaker *(^)(CGFloat, CGFloat, CGFloat, CGFloat))addQuadCurveTo {
...
- (LSPuzzlePathMaker *(^)(CGFloat, CGFloat, CGFloat, CGFloat, CGFloat, CGFloat))addCurveTo {
...
- (LSPuzzlePathMaker *(^)(CGFloat, CGFloat, CGFloat, CGFloat, CGFloat, BOOL))addArcWithCenter {
...
- (LSPuzzlePathMaker *(^)(CGFloat, CGFloat, CGFloat, CGFloat, CGFloat, BOOL, BOOL))addArcWithPoint {
...
- (LSPuzzlePathMaker *(^)(void))closePath {
    return ^(void){
        [self.path closePath];
        return self;
    };
...
- (LSPuzzlePathMaker *(^)(CGFloat, CGFloat, CGFloat, CGFloat, CGFloat))addSin {
...
- (LSPuzzlePathMaker *(^)(LSPathMirrorAxis, CGFloat, CGFloat, CGFloat, CGFloat))mirror {
    return ^(LSPathMirrorAxis axis, CGFloat x, CGFloat y, CGFloat width, CGFloat height){
        [self mirrorPathWithAxis:axis rect:CGRectMake(x, y, width, height)];
        return self;
    };
}

- (LSPuzzlePathMaker *(^)(CGFloat))scale {
...
- (LSPuzzlePathMaker *(^)(CGFloat))rotate {
...
- (LSPuzzlePathMaker *(^)(CGFloat, CGFloat))translate {
...
- (LSPuzzlePathMaker *(^)(void))moveToOrigin {
    return ^(void){
...
- (void)mirrorPathWithAxis:(LSPathMirrorAxis)axis rect:(CGRect)rect {
    switch (axis) {
        case LSPathMirrorAxisX:
