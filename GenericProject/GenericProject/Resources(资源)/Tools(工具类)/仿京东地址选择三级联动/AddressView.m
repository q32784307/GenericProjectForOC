...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        //获取本地json数据
        NSArray *jsonArray = [self readLocalFileWithName:@"城市数据"];
        self.datasArr = [AddressModel mj_objectArrayWithKeyValuesArray:jsonArray];
...
- (void)addTitleView {
    ...
    self.tableView1.block = ^(NSInteger row){
        ...
        weakSelf.stateLabel.frame = CGRectMake(0, 55 * IPHONE6_SIZE, 30 + [AppUtils widthOfString:weakSelf.oneModel.name font:15 height:30 *IPHONE6_SIZE], 30 *IPHONE6_SIZE);
        [UIView animateWithDuration:0.5 animations:^{
            ...
            weakSelf.stateLabel.text = weakSelf.oneModel.name;
        }];
        ...
        weakSelf.datasArr1 = [AddressModel mj_objectArrayWithKeyValuesArray:weakSelf.oneModel.district];
...
- (AddressTableView *)tableView2 {
    if (!_tableView2) {
        ...
        _tableView2.block = ^(NSInteger row){
            ...
            weakSelf.cityLabel.frame = CGRectMake(CGRectGetMaxX(weakSelf.stateLabel.frame), 55 *IPHONE6_SIZE, 30 + [AppUtils widthOfString:weakSelf.twoModel.name font:15 height:30 *IPHONE6_SIZE], 30 *IPHONE6_SIZE);
            [UIView animateWithDuration:0.5 animations:^{
                ...
                weakSelf.cityLabel.text = weakSelf.twoModel.name;
            }];
            ...
            weakSelf.datasArr2 = [AddressModel mj_objectArrayWithKeyValuesArray:weakSelf.twoModel.district];
            [weakSelf.tableView3 removeFromSuperview];
            weakSelf.tableView3 = nil;
...
- (AddressTableView *)tableView3 {
    if (!_tableView3) {
        ...
        _tableView3.block = ^(NSInteger row){
            AddressModel *threeModel = weakSelf.datasArr2[row];
            NSMutableDictionary *dic = [[NSMutableDictionary alloc] init];
            dic[@"province"] = weakSelf.oneModel.name;
            dic[@"city"] = weakSelf.twoModel.name;
            dic[@"area"] = threeModel.name;
            
            dic[@"provinceId"] = weakSelf.oneModel.zipcode;
            dic[@"cityId"] = weakSelf.twoModel.zipcode;
            dic[@"areaId"] = threeModel.zipcode;
