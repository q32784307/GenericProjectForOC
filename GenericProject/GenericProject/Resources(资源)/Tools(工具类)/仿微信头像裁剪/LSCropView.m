...
@interface LSCropView ()<UIScrollViewDelegate,UIGestureRecognizerDelegate,LSDCropRectViewDelegate>

@property(nonatomic,strong)UIScrollView *scrollView;
@property(nonatomic,strong)UIView *zoomingView;
@property(nonatomic,strong)UIImageView *imageView;

@property(nonatomic,strong)LSCropRectView *cropRectView;
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.cropRectView = [[LSCropRectView alloc] init];
...
- (UIImage *)croppedImage {
    // 发送开始裁剪代理
    if (self.delegate &&
        [self.delegate respondsToSelector:@selector(lsdOptionalDidBeginingTailor:)]) {
        [self.delegate lsdOptionalDidBeginingTailor:self];
    }
    ...
    // 发送结束裁剪代理
    if (self.delegate &&
        [self.delegate respondsToSelector:@selector(lsdOptionalDidFinishTailor:)]) {
        [self.delegate lsdOptionalDidFinishTailor:self];
    }
...
- (CGRect)cappedCropRectInImageRectWithCropRectView:(LSCropRectView *)cropRectView {
...
#pragma mark -
- (void)lsOptionalCropRectViewDidBeginEditing:(LSCropRectView *)cropRectView {
    self.resizing = YES;
    self.isZoom = YES;
}

- (void)lsOptionalCropRectViewEditingChanged:(LSCropRectView *)cropRectView {
...
- (void)lsOptionalCropRectViewDidEndEditing:(LSCropRectView *)cropRectView {
    self.resizing = NO;
