//
//  LSMultistageScrollViewHelper.m
//  GenericProject
//
...
@interface LSMultistageScrollViewHelper ()
...
//事件转发
@property(nonatomic)LSMultistageScrollViewProxy *baseScrollViewProxy;
@property(nonatomic)LSMultistageScrollViewProxy *subScrollViewProxy;

@property(nonatomic,assign,getter=baseViewScrolling)BOOL baseViewScroll;

@end

@implementation LSMultistageScrollViewHelper
...
- (LSMultistageScrollViewProxy *)baseScrollViewProxy {
    if (!_baseScrollViewProxy) {
        _baseScrollViewProxy = [LSMultistageScrollViewProxy alloc];
        _baseScrollViewProxy.helperTarget = self;
    }
    return _baseScrollViewProxy;
}

- (LSMultistageScrollViewProxy *)subScrollViewProxy {
    if (!_subScrollViewProxy) {
        _subScrollViewProxy = [LSMultistageScrollViewProxy alloc];
