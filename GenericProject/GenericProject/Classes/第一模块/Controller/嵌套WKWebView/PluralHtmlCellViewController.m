//
//  PluralHtmlCellViewController.m
//  GenericProject
//
...
@interface PluralHtmlCellViewController ()<UITableViewDelegate,UITableViewDataSource,UIScrollViewDelegate,LSAdaptiveHTMLCellDelegate>
...
@implementation PluralHtmlCellViewController
...
- (LSAdaptiveHTMLCell *)cell {
    if (!_cell) {
        ...
        _cell = [[LSAdaptiveHTMLCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellTableIndentifier1];
    }
    return _cell;
}
