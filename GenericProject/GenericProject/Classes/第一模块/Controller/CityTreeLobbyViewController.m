...
- (void)createSubViews {
    ...
    [titleLabel1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.view).with.offset(NAVIGATION_BAR_HEIGHT + SYRealValue(30 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.mySwitch1 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.view).with.offset(NAVIGATION_BAR_HEIGHT + SYRealValue(30 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [titleLabel2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(titleLabel1.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.mySwitch2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mySwitch1.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [titleLabel3 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(titleLabel2.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.mySwitch3 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mySwitch2.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [titleLabel4 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(titleLabel3.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.mySwitch4 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mySwitch3.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [titleLabel5 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(titleLabel4.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.mySwitch5 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mySwitch4.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [titleLabel6 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(titleLabel5.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.mySwitch6 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mySwitch5.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [titleLabel7 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(titleLabel6.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.mySwitch7 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mySwitch6.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [titleLabel8 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(titleLabel7.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.mySwitch8 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mySwitch7.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [titleLabel9 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(titleLabel8.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.mySwitch9 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mySwitch8.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [titleLabel10 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(titleLabel9.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.mySwitch10 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.mySwitch9.mas_bottom).with.offset(SYRealValue(50 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
    ...
    [self.bottomLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(self.view.mas_bottom).with.offset(-HOME_INDICATOR_HEIGHT + SYRealValue(-50 / 2));
        make.left.equalTo(self.view).with.offset(SYRealValue(30 / 2));
        make.right.equalTo(self.view.mas_right).with.offset(SYRealValue(-30 / 2));
        make.height.mas_equalTo(SYRealValue(30 / 2));
    }];
